...
public interface RfidBindOrderMapper {
     ...
     * @return 结果
     */
	public int updateShipmentStatus(String orderNo);
     ...
     * @return 结果
     */
	public int updateEnteringTime(String orderNo);
     ...
     * @return 结果
     */
	public int updateLeaveTime(String orderNo);
	 ...
	 * @return
	 */
	public int updateOrderNo(String newOrderNo,String oldOrderNo);
